...
<h2> SET RESULT FOR 100LEVEL        </h2>	<hr/>
<a href="home2.php"><< BACK  </a> 
	
<form name="grade"	method="POST" class="form-style-1" action="php/form_process.php?u=<?php echo $s_uname;?>" >
<ul>
	<li>  <?php echo $one; ?>
...
<input  type="submit" name="grade" value="SUBMIT RESULT" />
