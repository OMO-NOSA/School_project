...
<ul>
	<li><a href="200level_result.php?su=<?php echo $s_uname; ?>&m_num=<?php echo $mat_no; ?> ">SET 200 LEVEL RESULT   </a>   </li>
	<li><a href="edit_grade2.php?su=<?php echo $s_uname; ?>&m_num=<?php echo $mat_no; ?> ">EDIT 200 LEVEL RESULT   </a>   </li>
