...
$result="";
 ...
 $query1 ="SELECT * FROM 300level WHERE username='$uname' AND reg_status='1' ";
...
$query2 ="SELECT * FROM 300level_result WHERE username='$uname' ";
