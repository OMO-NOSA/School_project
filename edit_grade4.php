...
$mat_no=$_GET['m_num']; 
 ...
 $query2 ="SELECT * FROM 400level WHERE username ='$s_uname' ";
...
<h2>EDIT STUDENT Grade</h2>	<hr/>
<a href="400level.php"><< BACK  </a> 
	
<form name="editgrade400"	method="POST" class="form-style-1" action="php/form_process.php?u=<?php echo $s_uname;?>" >
<ul>
	<li>  <?php echo $one; ?>
...
<input  type="submit" name="editgrade400" value="SUBMIT RESULT" />
