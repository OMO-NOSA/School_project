...
$mat_no=$_GET['m_num']; 
 ...
 $query2 ="SELECT * FROM 300level WHERE username ='$s_uname' AND reg_status='1' ";
...
<h2> SET RESULT FOR 300LEVEL </h2>	 <hr/>
<a href="300level.php"><< BACK  </a> 
	
<form name="grade300"	method="POST" class="form-style-1" action="php/form_process.php?u=<?php echo $s_uname;?>" >
<ul>
	<li>  <?php echo $one; ?>
...
<input  type="submit" name="grade300" value="SUBMIT RESULT" />
