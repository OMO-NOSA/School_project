...
$mat_no=$_GET['m_num']; 
 ...
 $query2 ="SELECT * FROM 200level WHERE username ='$s_uname' ";
...
<h2> EDIT 200LEVEL RESULT Grade</h2>	<hr/>
<a href="200level.php"><< BACK  </a> 
	
<form name="editgrade200"	method="POST" class="form-style-1" action="php/form_process.php?u=<?php echo $s_uname;?>" >
<ul>
	<li>  <?php echo $one; ?>
...
<input  type="submit" name="editgrade200" value="SUBMIT RESULT" />
