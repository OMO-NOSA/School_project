...
$mat_no=$_GET['m_num']; 
 ...
 $query2 ="SELECT * FROM 300level WHERE username ='$s_uname' ";
...
<h2>EDIT 300LEVEL GRADE </h2> <hr/>
<a href="300level.php"><< BACK  </a> 	
	
<form name="editgrade300"	method="POST" class="form-style-1" action="php/form_process.php?u=<?php echo $s_uname;?>" >
<ul>
	<li>  <?php echo $one; ?>
...
<input  type="submit" name="editgrade300" value="SUBMIT RESULT" />
