...
$mat_no=$_GET['m_num']; 
 ...
 $query2 ="SELECT * FROM 100level WHERE username ='$s_uname' AND reg_status='1' ";
...
<h2> Edit 100LEVEL Grade</h2><hr/>
<a href="home2.php"><< BACK  </a> 	
	
<form name="editgrade100"	method="POST" class="form-style-1" action="php/form_process.php?u=<?php echo $s_uname;?>" >
<ul>
	<li>  <?php echo $one; ?>
 ...
 <hr/>
		...
		<li> <?php echo $sixteen; ?>
		<input  type="radio" name="sixteen" value="<?php echo $a16;?> " /> a  
		<input  type="radio" name="sixteen" value="<?php echo $b16;?> " /> b  
		<input  type="radio" name="sixteen" value="<?php echo $c16;?> " /> c  
		<input  type="radio" name="sixteen" value="<?php echo $d16;?> " /> d  
		<input  type="radio" name="sixteen" value="<?php echo $e16;?> " /> e  
		<input  type="radio" name="sixteen" value="<?php echo $f16;?> " /> f  
	</li>
	
 <hr/>
	
		<li> <?php echo $seventeen; ?>
		<input  type="radio" name="seventeen" value="<?php echo $a17;?> " /> a  
		<input  type="radio" name="seventeen" value="<?php echo $b17;?> " /> b  
		<input  type="radio" name="seventeen" value="<?php echo $c17;?> " /> c  
		<input  type="radio" name="seventeen" value="<?php echo $d17;?> " /> d  
		<input  type="radio" name="seventeen" value="<?php echo $e17;?> " /> e  
		<input  type="radio" name="seventeen" value="<?php echo $f17;?> " /> f  
	</li>	

 <hr/>
	
		<li> <?php echo $eighteen; ?>
		<input  type="radio" name="eighteen" value="<?php echo $a18;?> " /> a  
		<input  type="radio" name="eighteen" value="<?php echo $b18;?> " /> b  
		<input  type="radio" name="eighteen" value="<?php echo $c18;?> " /> c  
		<input  type="radio" name="eighteen" value="<?php echo $d18;?> " /> d  
		<input  type="radio" name="eighteen" value="<?php echo $e18;?> " /> e  
		<input  type="radio" name="eighteen" value="<?php echo $f18;?> " /> f  
	</li>	

</ul>	

<input  type="submit" name="editgrade100" value="SUBMIT RESULT" />
