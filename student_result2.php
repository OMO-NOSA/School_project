...
$result="";
 ...
 $query1 ="SELECT * FROM 200level WHERE username='$uname' AND reg_status='1' ";
...
$query2 ="SELECT * FROM 200level_result WHERE username='$uname' ";
...
$t1=$rone+$rtwo+$rthree+$rfour+$rfive+$rsix+$rseven+$reight+$rnine+
		$rten+$releven+$rtwelve+$rthirteen+$rfourteen;
