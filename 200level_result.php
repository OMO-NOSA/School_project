...
$mat_no=$_GET['m_num']; 
 ...
 $query2 ="SELECT * FROM 200level WHERE username ='$s_uname' AND reg_status='1' ";
...
<html>
<head>
<title>set 200level result  </title>
<meta name="" content="">
...
<h2> SET RESULT FOR 200LEVEL </h2>
<a href="200level.php"><< BACK  </a> 	
	
<form name="grade200"	method="POST" class="form-style-1" action="php/form_process.php?u=<?php echo $s_uname;?>" >
<ul>
	<li>  <?php echo $one; ?>
...
<input  type="submit" name="grade200" value="SUBMIT RESULT" />
